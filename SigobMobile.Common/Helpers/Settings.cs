namespace SigobMobile.Common.Helpers
{
    ...
    {
        private static readonly int CalendarDayView = 6;
        ...
        private static readonly int SettingsCalendarViewDefault = CalendarDayView;

        private const string selectedDocumentTray = "selectedDocumentTray";
        private static readonly int SettingsDocumentTrayDefault = -1;
        ...
        /// <summary>
        /// Gets or sets the default tray in Correspondence App
        /// </summary>
        public static int DocumentTraySelected
        {
            get => AppSettings.GetValueOrDefault(selectedDocumentTray, SettingsDocumentTrayDefault);
            set => AppSettings.AddOrUpdateValue(selectedDocumentTray, value);
        }
